...
//		mapClient.setMapServer(config.getServerAddress(), config.getServerPort(),config.getRemotePort()	,config
// .getPasswordMd5(),config.getPasswordMd5_Proxy(),config.isDirect_cn());
    }
