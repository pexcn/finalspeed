...
public class MapClient implements Trafficlistener {
    ...
    final Object syn_process = new Object();
    ...
    public void setMapServer(String serverAddress, int serverPort, int remotePort, String passwordMd5, String
            password_proxy_Md5, boolean direct_cn, boolean tcp,
                             String password) {
